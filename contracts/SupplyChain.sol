...
contract SupplyChain {
  ...
  modifier verifyCaller (address _address) { 
    require(msg.sender == _address, "the message sender is not the caller"); 
    _;
  }

  modifier paidEnough(uint _price) { 
    require(msg.value >= _price, "buyer has not paid enough"); 
    _;
  }
  ...
  constructor(){ 
    ...
    owner = msg.sender;
    skuCount = 0; // not necessary as variables are initiated to zero by default.
  }
